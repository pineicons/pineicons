...
async function buildExports(styles) {
  ...
  pkg['./tinted'] = { default: './tinted/index.js' }
  pkg['./tinted/index'] = { default: './tinted/index.js' }
  pkg['./tinted/index.js'] = { default: './tinted/index.js' }
...
async function main(package) {
  ...
  await Promise.all([
    rimraf(`./${package}/icons/outline/*`),
    rimraf(`./${package}/icons/solid/*`),
    rimraf(`./${package}/icons/tinted/*`),
  ])
  ...
  await Promise.all([
    ...
    buildIcons(package, 'icons/tinted', 'cjs'),
    buildIcons(package, 'icons/tinted', 'esm'),
    ...
    ensureWriteJson(`./${package}/icons/tinted/esm/package.json`, esmPackageJson),
    ensureWriteJson(`./${package}/icons/tinted/package.json`, cjsPackageJson),
  ])

  let packageJson = JSON.parse(await fs.readFile(`./${package}/package.json`, 'utf8'))

  packageJson.exports = await buildExports(['icons/outline', 'icons/solid', 'icons/tinted'])
